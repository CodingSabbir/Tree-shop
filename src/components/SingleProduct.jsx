...
const SingleProduct = () => {
  ...
  <span className="mx-1"><FaChevronRight /></span>
  <a href="/shop" className="text-black font-bold hover:text-gray-800">Shop</a>
                </div>
                <div className='mt-6 sm:mt-10'>
                  <div className='grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 h-max gap-6'>
                  <div>
                    ...
                    <div>
                        ...
                        <div className='mt-3'>
                            <div className='flex flex-col text-left w-full gap-1'>
                                <p className='font-semibold'>Qunatity</p>
                                <input  onInput={handleInput} type="number" name='quantity' id='quantity' value={quantity} defaultValue={1} required className='font-semibold mb-1 border border-gray-300 text-sm max-w-full w-full outline-none rounded-md py-3 md:py-3 px-4 md:px-4 m-0 focus:border-[#65B741]'/>
                                
                            </div>
                            <div className='w-full text-left my-4'>
                            <button className='flex justify-center items-center px-4 w-full py-3 gap-2 bg-[#65B741] text-white font-bold border border-[#65B741] ease-in-out rounded-md duration-150 shadow-slate-600 hover:bg-white hover:text-black lg:m-0 md:px-6'><span>Confirmed Order</span><FaArrowCircleRight/></button>
                            </div>
                        </div>
                    </div>
                  </div>
